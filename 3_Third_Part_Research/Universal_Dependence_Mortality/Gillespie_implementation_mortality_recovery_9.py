...
array_principal = np.zeros((len(valores_de_mu),) + (len(valores_de_recovery),) + (num_cel,80,3 ))
...
for posicion_mu, mu in enumerate(tqdm(valores_de_mu)):
    for posicion_recovery, r in enumerate(tqdm((valores_de_recovery))):
        ...
        np.save('/Users/rafther0112/Documents/GitHub/AGING_RESULTS_SIMULATIONS/Simulacion_cruzado_Recovery_Mortalidad_PowerLaw_9.npy', array_principal)
