...
s = (1/tiempo_maximo)
C = 3
mu = 0.05 #Parametro que estamos modificando
...
for posicion_damage, a in enumerate(tqdm(valores_de_damage)):
    for posicion_recovery, r in enumerate(tqdm((valores_de_recovery))):
        ...
        np.save('/Users/rafther0112/Documents/GitHub/AGING_RESULTS_SIMULATIONS/Simulacion_cruzado_Damage_Recovery_PowerLaw_005.npy', array_principal)
# %%
