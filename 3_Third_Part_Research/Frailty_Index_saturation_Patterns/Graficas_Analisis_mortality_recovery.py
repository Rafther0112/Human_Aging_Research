...
#%%
moratility_repair_cross_experimentation = np.load('/Users/rafther0112/Documents/GitHub/AGING_RESULTS_SIMULATIONS/Simulacion_cruzado_Recovery_Mortalidad_FINAL.npy', allow_pickle=True)
...
for mortalidad_fija in tqdm(moratility_repair_cross_experimentation):
    ...
    for frailty_curves in mortalidad_fija:
        ...
        for tiempo in np.arange(0,80):
            ...
            for persona in np.arange(0,4000):
...
ax1.set_xlabel(r'Recovery position', fontsize=14)
...
ax2.set_xlabel(r'Recovery position', fontsize=14)
