...
valores_de_mu = np.linspace(0.50, 0.90, 0.01)
...
#%%
np.save('/Users/rafther0112/Documents/GitHub/AGING_RESULTS_SIMULATIONS/Simulacion_modificacion_tasa_mortalidad_FINAL.npy', array_principal)
