...
#%%
damage_repair_cross_experimentation = np.load('/Users/rafther0112/Documents/GitHub/AGING_RESULTS_SIMULATIONS/Simulacion_cruzado_Damage_Recovery_conmu_seis.npy', allow_pickle=True)
# %%
...
for posicion_damage in range(len(valores_de_damage)):
    ...
    plt.savefig(f"Gif_results_damage_recovery_nueve/Gif_{posicion_damage}.jpg", dpi = 200)
